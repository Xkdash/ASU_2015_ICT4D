                ...
                <td class="auto-style19">
                    <asp:Panel ID="Panel3" runat="server" Height="940px">
                        <div class="auto-style9">
                            ...
                            &nbsp;
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/education_rabi.aspx">রবীন্দ্র মুক্ত বিদ্যালয় </asp:HyperLink>
                            <br />
                            <br />
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/education_rash.aspx">রাষ্ট্রীয় মুক্ত বিদ্যালয়ী শিক্ষা সংস্থান </asp:HyperLink>
                            &nbsp;<br />
                            <br />
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/education_netaji.aspx"> নেতাজী সুভাষ মুক্ত বিশ্ববিদ্যালয়</asp:HyperLink>
                            <br />
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Image ID="Image9" runat="server" Height="120px" ImageUrl="~/images/ICT4D png/ignu.png" Width="128px" />
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/education_indira.aspx">ইন্দিরা গান্ধী জাতীয় মুক্ত বিশ্ববিদ্যালয়</asp:HyperLink>
                            &nbsp;<br />
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Image ID="Image8" runat="server" Height="100px" ImageUrl="~/images/ICT4D png/dd_doordarshan_hd.png" Width="125px" />
                            &nbsp;&nbsp;&nbsp;
                            <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/education_gyanbani.aspx">জ্ঞানবাণী </asp:HyperLink>
                            &nbsp;<br />
                            <br />
                            <br />
                            <br />
                            ...
                            &nbsp;&nbsp;
                            <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/education_gyandarshan.aspx">জ্ঞানদর্শন</asp:HyperLink>
                            <br />
                            <br />
                            <br />
                            <br />
