<%@ Page Title="" Language="C#" MasterPageFile="~/inner_master.master" AutoEventWireup="true" CodeFile="job_workplace.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <asp:Panel ID="Panel1" runat="server" Height="217px">
        ...
        <asp:Panel ID="Panel3" runat="server">
            <iframe id="I1" name="I1" src="http://www.ekarmakshetra.com" style="width:100% ; height: 534px"></iframe>
    </asp:Panel>
    </asp:Content>
